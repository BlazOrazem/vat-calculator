...
<head lang="en">
    ...
    <meta name="description" content="Calculate VAT value based on a given amount. VAT can be added to or subtracted from the amount."/>
    <meta name="keywords" content="vat, calculator, vat calculator">
    <meta name="author" content="Blaž Oražem">

    <title>VAT Calculator - calculate VAT value based on a given amount</title>
    ...
    <div class="row row-center justify-content-lg-center pt-4 toggle">
        <div class="btn-group btn-group-toggle">
            ...
            <label class="btn btn-success" data-operation="0">
                <input type="radio" name="operation" autocomplete="off" value="0" v-model="operation"> Subtract VAT
            </label>
        </div>
    </div>
    ...
    <div class="row justify-content-lg-center pt-3">
        <div class="col col-lg-6">
            <div class="form-group row results">
                <label for="inputComputedVat" class="col-6 col-form-label text-right font-weight-bold">
                    VAT value
                </label>
                <div class="col-4">
                    <input type="text" class="form-control text-right" id="inputComputedVat" v-model="resultVat" readonly>
                </div>
                <label class="col-2 col-form-label font-weight-bold">€</label>
            </div>
            <div class="form-group row results">
                <label for="inputComputedAmount" class="col-6 col-form-label text-right font-weight-bold">
                    Amount {{ state }} VAT
                </label>
                <div class="col-4">
                    <input type="text" class="form-control text-right" id="inputComputedAmount" v-model="resultAmount" readonly>
                </div>
                <label class="col-2 col-form-label font-weight-bold">€</label>
            </div>
        </div>
...
<footer>
    <p class="text-center">
        &copy; <a href="https://www.orazem.si" target="_blank">Orazem.si</a> <?= date('Y') ?>. All right reserved.
    </p>
    <p class="text-center">
